...
def main():
    ...
    while True:
        try:
            ...
            # Добавляем индикатор ожидания (Spinner)
            with console.status("[bold blue]Агент думает...") as status:
                result = agent.run(
                    user_input, 
            ...
            # Вывод ответа в виде Markdown внутри панели
